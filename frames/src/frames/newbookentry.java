 ...
 * @author 123
 */
public class newbookentry extends javax.swing.JFrame {
...
//        new dataofBooks(id,name,author,publisher,quantity).setVisible(true);
 ...
 String sql = "INSERT INTO APP.BOOKS (ID, NAME,AUTHOR,PUBLISHER,QUANTITY) VALUES ('"+id+"','"+name+"','"+author+"','"+publisher+"','"+quantity+"')";
 ...
 jTextField3.setText(null);// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(newbookentry.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new newbookentry().setVisible(true);
            }
        });
    }
