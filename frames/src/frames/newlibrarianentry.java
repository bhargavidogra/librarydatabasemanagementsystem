 ...
 * @author 123
 */
public class newlibrarianentry extends javax.swing.JFrame {

   
    public newlibrarianentry() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("NEW LIBRARIAN ENTRY");
...
String connectionURL = "jdbc:derby://localhost:1527/libdata;create=true";
 ...
 String sql = "INSERT INTO APP.LIBRARIANS (ID, NAME,PASSWORD,EMAIL,ADDRESS,CITY,CONTACT) VALUES ('"+id+"','"+name+"','"+password+"','"+email+"','"+address+"','"+city+"','"+contact+"')";
 ...
 System.out.println("Connect failed ! "+ex);
    ...
    JOptionPane.showMessageDialog(jPanel1,"Successfully insertion");
 ...
 jTextField5.setText(null);// TODO add your handling code here:
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        AdminSection nf=new AdminSection();
        nf.setVisible(true);
        setVisible(false);// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(newlibrarianentry.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new newlibrarianentry().setVisible(true);
            }
        });
    }
