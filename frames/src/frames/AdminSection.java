...
public class AdminSection extends javax.swing.JFrame {
 ...
 String sql = "SELECT * FROM APP.LIBRARIANS";
 Statement st = conn.createStatement();
 ResultSet rs=null;
 rs=st.executeQuery(sql);
 while(rs.next()){
 System.out.println(rs.getInt("id")+"\t"+rs.getString("name")+"\t"+rs.getString("password")+"\t"+rs.getString("email")+"\t"+rs.getString("Address")+"\t"+rs.getString("city")+"\t"+rs.getString("contact"));
 }
 rs.close();
 st.close();
 conn.close();
 ...
 System.out.println("Connect failed ! ");
     ...
     //   new dataofLibrarians().setVisible(false);  
...
AdminJFrame af=new AdminJFrame();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        newlibrarianentry nlb=new newlibrarianentry();
        nlb.setVisible(true);
        setVisible(false);
